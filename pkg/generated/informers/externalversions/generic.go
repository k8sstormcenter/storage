...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("containerprofiles"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Spdx().V1beta1().ContainerProfiles().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("rogueartifacts"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Spdx().V1beta1().RogueArtifacts().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("seccompprofiles"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Spdx().V1beta1().SeccompProfiles().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("workloadconfigurationscansummaries"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Spdx().V1beta1().WorkloadConfigurationScanSummaries().Informer()}, nil
